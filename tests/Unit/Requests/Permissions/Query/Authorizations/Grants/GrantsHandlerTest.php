...
use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Permissions\Query\Authorizations\Grants\GrantsRequestFixture;
use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Permissions\Query\Authorizations\Grants\GrantsResponseFixture;
...
test('valid response', function (GrantsRequestFixture $requestFixture, GrantsResponseFixture $responseFixture): void {
    ...
    $response = $clientStub->permissions()->query()->authorizations()->grants($requestFixture->data)->object();
...
test('invalid response', function (): void {
    ...
    expect(function () use ($responseFixture): void {
        ...
        $clientStub->permissions()->query()->authorizations()->grants($requestFixture->data);
