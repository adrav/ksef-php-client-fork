...
use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Permissions\Query\Persons\Grants\GrantsRequestFixture;
use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Permissions\Query\Persons\Grants\GrantsResponseFixture;
...
test('valid response', function (GrantsRequestFixture $requestFixture, GrantsResponseFixture $responseFixture): void {
    ...
    $response = $clientStub->permissions()->query()->persons()->grants($requestFixture->data)->object();
...
test('invalid response', function (): void {
    ...
    expect(function () use ($responseFixture): void {
        ...
        $clientStub->permissions()->query()->persons()->grants($requestFixture->data);
