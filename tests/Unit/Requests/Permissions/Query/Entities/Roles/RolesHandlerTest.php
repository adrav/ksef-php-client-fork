...
use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Permissions\Query\Entities\Roles\RolesRequestFixture;
use N1ebieski\KSEFClient\Testing\Fixtures\Requests\Permissions\Query\Entities\Roles\RolesResponseFixture;
...
test('valid response', function (RolesRequestFixture $requestFixture, RolesResponseFixture $responseFixture): void {
    ...
    $response = $clientStub->permissions()->query()->entities()->roles($requestFixture->data)->object();
...
test('invalid response', function (): void {
    ...
    expect(function () use ($responseFixture): void {
        ...
        $clientStub->permissions()->query()->entities()->roles($requestFixture->data);
